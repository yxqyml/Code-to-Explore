#
# This python code is produe the starting video of the explaination video of
# Bertrand's paradox random chord selection method 3, i.e. # random 
# midpoints method.
#
from manim import *
...
class BertrandExplain(Scene):
    def construct(self):
        ...
        self.play(FadeOut(logo_g), run_time=3)
         ...
         # Sub titles
        sub_t1 = Text("Simulation of random chords selection method 3").next_to(logo_g, DOWN).scale(0.8)
        sub_t2 = Text("Random midpoint", color=RED_A).next_to(sub_t1, DOWN).scale(0.8)
