#
# This python code is about to explaine the method 1 of Bertrand's paradox, i.e.
# random endpoint method.
# This explaination video is purely produced by manim
#
from manim import *
...
class BertrandExplain(Scene):
    def construct(self):
        ...
        self.play(FadeOut(logo_g), run_time=3)
         ...
         # Sub titles
        sub_t1 = Text("Simulation of random chords selection method 1").next_to(logo_g, DOWN).scale(0.8)
